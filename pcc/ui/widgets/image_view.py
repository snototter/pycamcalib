...
Mostly copied from my iminspect package, with minor pcc-related modifications.
"""
...
class ImageViewer(QScrollArea):
    ...
    viewChanged = Signal()
    # Image file has been dropped onto canvas
    filenameDropped = Signal(str)
...
def run_demo():
    ...
    img_np = np.asarray(Image.open(
        os.path.join(os.path.dirname(
            os.path.abspath(__file__)), '..', '..', '..', 'sandbox', 'flamingo.jpg')).convert('RGB'))
